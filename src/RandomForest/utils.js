...
/**
 * Select n with replacement elements on the training set and values, where n
 * is the size of the training set.
 * @ignore
 * @param {Matrix} trainingSet
 * @param {Array} trainingValue
 * @param {number} seed - seed for the random selection, must be a 32-bit
 * integer.
...
/**
 * selects n features from the training set with or without replacement,
 * returns the new training set and the indexes used.
 * @ignore
 * @param {Matrix} trainingSet
...
/**
 * collects and combines the individual results from the tree predictions on
 * Out-Of-Bag data
 * @ignore
 * @param {{index: {Array},predicted: {Array}}[]} oob: array of individual
 * tree predictions
