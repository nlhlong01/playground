...
export class RandomForestRegression extends RandomForestBase {
   ...
   * @param {number} [options.maxFeatures=1.0] - the number of features used on
   * each estimator.
   ...
   * sample features.
   * @param {number} [options.seed=42] - seed for feature and samples selection,
   ...
   * @param {string} [options.selectionMethod="mean"] - the way to calculate the
   * prediction from estimators, "mean" and "median" are supported.
   * @param {boolean} [options.useSampleBagging=true] - use bagging over
   * training samples.
